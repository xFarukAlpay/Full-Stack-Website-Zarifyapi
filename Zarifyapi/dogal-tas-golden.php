    ...
    <section>
      <div style="position: relative; display: inline-block;">
        ...
        <div class="urunbaslik" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
          <h1 style="color: white; animation: myAnimationn 2s infinite;">GOLDEN SERİSİ</h1>
        </div>
      </div>
    </section>
    <br><br><br>
    <section class="our-wedding-feature container">
      <div class="our-wedding-grid">
        <div class="our-wedding-grid-item autumn">
          <div class="our-wedding-card"> <a href="assets/images/dogal-tas/GOLDEN4-min.jpg" data-lightbox="resim"
              data-title="Resmin Başlığı">
              <img loading="lazy" src="assets/images/dogal-tas/GOLDEN4-min.jpg" alt="düğün fotoğrafları"
        ...
        <div class="our-wedding-grid-item 2 atlas">
          <div class="our-wedding-card"> <a href="assets/images/dogal-tas/GOLDEN3-min.jpg" data-lightbox="resim"
              data-title="Resmin Başlığı">
              <img loading="lazy" src="assets/images/dogal-tas/GOLDEN3-min.jpg" class="our-wedding-card-img-top"
                alt="couple"></a>
            <div class="our-wedding-card-body">
        ...
        <div class="our-wedding-grid-item white">
          <div class="our-wedding-card"> <a href="assets/images/dogal-tas/GOLDEN2-min.jpg" data-lightbox="resim"
              data-title="Resmin Başlığı">
              <img loading="lazy" src="assets/images/dogal-tas/GOLDEN2-min.jpg" class="our-wedding-card-img-top"
                alt="white"></a>
            <div class="our-wedding-card-body">
        ...
        <div class="our-wedding-grid-item white">
          <div class="our-wedding-card"> <a href="assets/images/dogal-tas/GOLDEN1-min.jpg" data-lightbox="resim"
              data-title="Resmin Başlığı">
              <img loading="lazy" src="assets/images/dogal-tas/GOLDEN1-min.jpg" class="our-wedding-card-img-top"
                alt="white"></a>
            <div class="our-wedding-card-body">
