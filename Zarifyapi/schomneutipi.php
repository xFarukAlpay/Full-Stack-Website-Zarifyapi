...
<link rel="canonical" href="<?php echo $lang_array['home-url']; ?>" /><link rel="icon" href="assets/images/logo75px.png" type="image/x-icon">    <link rel="stylesheet" href="assets/css/lightbox.css" />
    ...
    <body>
        ...
        <div class="solust-resim-container">
            <a href="assets/images/schomne/u-tipi-uc-yonlu-asansorlu-hazne01-jpg-min.jpg" data-lightbox="resim"
                data-title="Resmin Başlığı">
                <img loading="lazy" class="solust-resim"
                    src="assets/images/schomne/u-tipi-uc-yonlu-asansorlu-hazne01-jpg-min.jpg" alt="Sol Üst Resim">
            </a>
        </div><!-- Küçük resimler -->
        <div class="kucuk-resim-container">s
            <a href="assets/images/schomne/u-tipi-uc-yonlu-asansorlu-hazne03-jpg-min.jpg" data-lightbox="resim"
                data-title="Küçük Resim 1">
                <img loading="lazy" class="kucuk-resim"
                    src="assets/images/schomne/u-tipi-uc-yonlu-asansorlu-hazne03-jpg-min.jpg" alt="Küçük Resim 1">
            </a>
            <a href="assets/images/schomne/u-tipi-uc-yonlu-asansorlu-hazne05-jpg-min.jpg" data-lightbox="resim"
                data-title="Küçük Resim 2">
                <img loading="lazy" class="kucuk-resim2"
                    src="assets/images/schomne/u-tipi-uc-yonlu-asansorlu-hazne05-jpg-min.jpg" alt="Küçük Resim 2">
            </a>
        </div><!-- Content -->
        <main>
            <section>
