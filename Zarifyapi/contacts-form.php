...
$connect = mysqli_connect("ftpupload.net", "epiz_33742341", "RnXyvDdY7xXV", "Zarif yapı");
...
try {
    ...
    //Recipients
    $mail->setFrom($kullanici, 'Zarif yapı Concept');
    $mail->addAddress('Zarif yapıcompany@gmail.com'); //Name is optional    //Attachments
