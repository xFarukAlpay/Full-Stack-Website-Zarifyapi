...
<title>
    <?php echo $lang_array['contacts-title']; ?>
</title>
...
<main>
    ...
    <section class="section-parallax page-image-title" style="background-image: url(assets/images/contact-back1.jpg);">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 px-md-5 mb-5 mb-lg-0">
                    ...
                    <h2 class="text-dark font-size-3">Bize ne zaman ihtiyacınız olursa, <span class="text-blue">Sizin
                            için</span> buradayız</h2>
                    <p class="pt-4 pb-5 text-text">Yardım etmek ve sahip olabileceğiniz herhangi bir soruyu yanıtlamak
                        için buradayız.
                        senden haber almak için sabırsızlanıyoruz</p>
                    <h6 class="d-inline-block me-5"><a href="tel:+90 5058108116" class="text-dark">+90 505 810 81 16</a>
                    </h6>
                    <h6 class="d-inline-block"><a href="mailto:zarifconceptyapi@gmail.com"
                            class="text-dark">ZARİFCONCEPTYAPİ@GMAİL.COM</a></h6>
                </div>
