...
<link rel="canonical" href="<?php echo $lang_array['home-url']; ?>" /><link rel="icon" href="assets/images/logo75px.png" type="image/x-icon">    <link rel="stylesheet" href="assets/css/lightbox.css" />
    ...
    <body>
        ...
        <div class="kucuk-resim-container">
            <a href="assets/images/3d-somine/ayflame_1000l1-min.jpg" data-lightbox="resim" data-title="Küçük Resim 1">
                <img loading="lazy" class="kucuk-resim" src="assets/images/3d-somine/ayflame_1000l1-min.jpg"
                    alt="Küçük Resim 1">
            </a>
            <a href="assets/images/3d-somine/ayflame_1000l4-min.jpg" data-lightbox="resim" data-title="Küçük Resim 2">
                <img loading="lazy" class="kucuk-resim2" src="assets/images/3d-somine/ayflame_1000l4-min.jpg"
                    alt="Küçük Resim 2">
            </a>
            <a href="assets/images/3d-somine/ayflame_1000l5-min.jpg" data-lightbox="resim" data-title="Küçük Resim 3">
                <img loading="lazy" class="kucuk-resim3" src="assets/images/3d-somine/ayflame_1000l5-min.jpg"
                    alt="Küçük Resim 3">
            </a>
            <a href="assets/images/3d-somine/ayflame_1000l8-min.jpg" data-lightbox="resim" data-title="Küçük Resim 4">
                <img loading="lazy" class="kucuk-resim4" src="assets/images/3d-somine/ayflame_1000l8-min.jpg"
                    alt="Küçük Resim 4">
            </a>
        </div>
        <main>
