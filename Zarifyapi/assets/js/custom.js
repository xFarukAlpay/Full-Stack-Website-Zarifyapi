...
(function($) {
    ...
    // This Year	
    document.getElementById("thisyear").innerHTML = new Date().getFullYear();    // Input Autocomplete off	
    $("input").attr("autocomplete", "off");    // Imgages Draggable off
    $('img').attr('draggable', false);
    $('img').attr('loading', 'lazy');
    $('a').attr('draggable', false);    // SlideHeader
    (function() {
