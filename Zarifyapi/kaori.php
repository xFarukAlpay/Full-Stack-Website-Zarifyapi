    ...
    <section>
      <div style="position: relative; display: inline-block;">
        ...
        <div class="urunbaslik" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
          <h1 style="color: white; animation: myAnimationn 2s infinite;">Döküm Odun Sobası</h1>
        </div>
      </div>
      </div>
    </section> <br><br><br><br>
      ...
      <div class="our-wedding-grid">
        <div class="our-wedding-grid-item couple">
          <div class="our-wedding-card">
            <img loading="lazy" src="assets/images/soba/Kaori D/647844-poele-kaori.jpg" alt="düğün fotoğrafları"
              class="our-wedding-card-img-top">
            <div class="our-wedding-card-body">
              <h5 class="our-wedding-card-title">Kaori Döküm Odun Sobası</h5>
              <p class="our-wedding-card-text">Ürün Detayları Ve Uygulama Görselleri İçin Tıklayınız..
              </p>
              <a href="kaoribasic.php" class="btn btn-primary">Detaylar İçin</a>
            </div>
          </div>
        </div>
        <div class="our-wedding-grid-item event">
          <div class="our-wedding-card">
            <img loading="lazy" src="assets/images/soba/Kaori Z/WhatsApp-Image-2021-09-01-at-14.56.01.jpeg"
            ...
            <div class="our-wedding-card-body">
              ...
              <a href="kaorizen.php" class="btn btn-primary">Detaylar İçin</a>
            </div>
          </div>
        </div>
      </div>
