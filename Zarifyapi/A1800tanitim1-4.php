...
<link rel="canonical" href="<?php echo $lang_array['home-url']; ?>" /><link rel="icon" href="assets/images/logo75px.png" type="image/x-icon">    <link rel="stylesheet" href="assets/css/lightbox.css" />
    ...
    <body>
        ...
        <div class="solust-resim-container">
            <a href="assets/images/2d-somine/A1800/Basliksiz-1-scaled.jpg" data-lightbox="resim"
                data-title="Resmin Başlığı">
                <img loading="lazy" class="solust-resim" src="assets/images/2d-somine/A1800/Basliksiz-1-scaled.jpg"
                    alt="Sol Üst Resim">
            </a>
        </div><!-- Küçük resimler -->
        <div class="kucuk-resim-container">
            <a href="assets/images/2d-somine/A1800/180cmliik-600x424.jpg" data-lightbox="resim"
                data-title="Küçük Resim 1">
                <img loading="lazy" class="kucuk-resim" src="assets/images/2d-somine/A1800/180cmliik-600x424.jpg"
                    alt="Küçük Resim 1">
            </a>
        </div><!-- Content -->
        <main>
                ...
                <div class="container">
                    <div class="sag-liste-kapsayici">
                        <ul class="sag-liste">
                            ...
                            <li>Manuel kumanda</li>
                            <li>Güvenlik şalteri</li>
                            <li> 900 – 1800 Watt iki kademe ısıtma sistemi</li>
                            <li>Ayarlanabilir alev efekti</li>
                            <li>Isıtmadan bağımsız alev efekti</li>
                            <li>Ateş ses efekti</li>
                            <li>Zaman ayarı</li>
                            <li>Alt ön panelden sıcak hava çıkışı</li>
                            <li> Bluetooth Opsiyonları Mevcuttur.</li>
                        </ul>
                    </div>
                </div>
            </section>
            <div class="example">
                <h2>AÇIKLAMA</h2>
                <p>Elektrikli şömineler, geleneksel odun veya gazlı şöminelere alternatif olarak kullanılan
                    modern ve pratik ısınma ve dekoratif araçlardır. A1800 2D elektrikli şömine, bu tür
                    elektrikli şöminelerden biridir. Bu şömine, gerçek alev efekti ve ısıtma sağlamak için
                    elektrik enerjisini kullanır. İşlevsel ve güvenli yapısıyla kullanıcılar için bir dizi
                    avantaj sunar.</p>
            </div>
        </main>
