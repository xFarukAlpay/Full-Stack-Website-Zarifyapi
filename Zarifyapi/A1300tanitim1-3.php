...
<link rel="canonical" href="<?php echo $lang_array['home-url']; ?>" /><link rel="icon" href="assets/images/logo75px.png" type="image/x-icon">    <link rel="stylesheet" href="assets/css/lightbox.css" />
    ...
    <body>
        ...
        <div class="solust-resim-container">
            <a href="assets/images/2d-somine/A1300/Basliksiz-2-1-100x100.jpg" data-lightbox="resim"
                data-title="Resmin Başlığı">
                <img loading="lazy" class="solust-resim" src="assets/images/2d-somine/A1300/Basliksiz-2-1-100x100.jpg"
                    alt="Sol Üst Resim">
            </a>
        </div><!-- Küçük resimler -->
        <div class="kucuk-resim-container">
            <a href="assets/images/2d-somine/A1300/130luk-scaled.jpg" data-lightbox="resim" data-title="Küçük Resim 1">
                <img loading="lazy" class="kucuk-resim" src="assets/images/2d-somine/A1300/130luk-scaled.jpg"
                    alt="Küçük Resim 1">
            </a>
        </div><!-- Content -->
        <main>
            ...
            <div class="example">
                ...
                <p>Elektrikli şömineler, geleneksel odun veya gazlı şöminelere alternatif olarak kullanılan
                    modern ve pratik ısınma ve dekoratif araçlardır. A1300 2D elektrikli şömine, bu tür
